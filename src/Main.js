                ...
                <div className="max-w-7xl mx-auto px-4 md:px-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-8 md:gap-12">
                        ...
                        <div className="md:block">
                            ...
                            >
                                <li><a href="#fleet" className="hover:text-[#0061ff] transition-colors duration-200 inline-block py-1">Notre Flotte</a></li>
                                <li><a href="#features" className="hover:text-[#0061ff] transition-colors duration-200 inline-block py-1">Avantages</a></li>
                                <li><a href="#contact" className="hover:text-[#0061ff] transition-colors duration-200 inline-block py-1">Contact</a></li>
                            </ul>
                        </div>
